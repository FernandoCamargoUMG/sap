    ...
    <div :class="[
      ...
      <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div class="pt-4">
          ...
          <router-link to="/reportes" @click="closeSidebarOnMobile" class="sidebar-link">
            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707v11a2 2 0 01-2 2z" />
            </svg>
            <span>Reportes Presupuestarios</span>
          </router-link>
