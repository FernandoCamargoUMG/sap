        ...
        >
          ...
          <div class="flex border-l border-gray-200">
            <button
              ...
              class="w-full border-0 rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-gray-600 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
