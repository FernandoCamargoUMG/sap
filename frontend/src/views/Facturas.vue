            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8 border border-gray-200">
                <div class="flex flex-wrap gap-4 items-center">
                    ...
                    <div class="flex-1 min-w-48">
                        ...
                        <input v-model="searchTerm" type="text" placeholder="Buscar por número de factura..."
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="factura in filteredFacturas" :key="factura.id"
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <span class="text-lg font-black text-green-600">Q{{
                                        formatMoney(factura.total_factura) }}</span>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <button @click="openEditModal(factura)"
                                        ...
                                        <button @click="confirmDelete(factura)"
