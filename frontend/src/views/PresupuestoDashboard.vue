        ...
        <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex space-x-3">
                    <button @click="$router.push('/presupuestos')"
            ...
            <div v-else-if="dashboardData">
                <PresupuestoDashboard :resumen="dashboardData.resumen" :renglones="dashboardData.renglones"
                    :loading="loading" />
            </div>
            ...
            <div v-else class="text-center py-20">
                <div class="bg-white rounded-2xl shadow-xl p-12 border border-gray-200">
                    ...
                    <p class="text-gray-600 mb-6">No se encontraron datos para mostrar en el dashboard presupuestario.
                    </p>
                    <button @click="$router.push('/presupuestos')"
